...
=error error_on_signature_parse
...
$test->for('error', 'error_on_signature_parse');

=example-1 error_on_signature_parse
...
$test->for('example', 1, 'error_on_signature_parse', sub {
  my ($tryable) = @_;
  my $result = $tryable->result;
  isa_ok $result, 'Venus::Error';
  my $name = $result->name;
  is $name, "on.signature.parse";
  my $render = $result->render;
  is $render, "Can't parse signature \"count()\"";
