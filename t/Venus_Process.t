...
This package may raise an C<on.chdir> error, as an instance of
C<Venus::Cli::Error>, via the C<error_on_chdir> method.
...
=example-1 error_on_chdir
  ...
  my $error = $parent->error_on_chdir({
    error => $!,
    path => '/nowhere',
    pid => 123,
  });
...
This package may raise an C<on.fork.process> error, as an instance of
C<Venus::Cli::Error>, via the C<error_on_fork_process> method.
...
=example-1 error_on_fork_process
  ...
  my $error = $parent->error_on_fork_process({
    error => $!,
    pid => 123,
  });
...
$test->for('example', 1, 'error_on_fork_process', sub {
  ...
  isa_ok $result, 'Venus::Error';
  my $name = $result->name;
  is $name, "on.fork.process";
  my $render = $result->render;
  is $render, "Can't fork process 123: $!";
...
This package may raise an C<on.fork.support> error, as an instance of
C<Venus::Cli::Error>, via the C<error_on_fork_support> method.
...
=example-1 error_on_fork_support
  ...
  my $error = $parent->error_on_fork_support({
    pid => 123,
  });
...
$test->for('example', 1, 'error_on_fork_support', sub {
  ...
  isa_ok $result, 'Venus::Error';
  my $name = $result->name;
  is $name, "on.fork.support";
  my $render = $result->render;
  is $render, "Can't fork process 123: Fork emulation not supported";
...
This package may raise an C<on.ping> error, as an instance of
C<Venus::Cli::Error>, via the C<error_on_ping> method.
...
$test->for('example', 1, 'error_on_ping', sub {
  ...
  is $name, "on.ping";
  my $render = $result->render;
  is $render, "Process 123 not responding to ping";
...
This package may raise an C<on.setid> error, as an instance of
C<Venus::Cli::Error>, via the C<error_on_setid> method.
...
=example-1 error_on_setid
  ...
  my $error = $parent->error_on_setid({
    error => $!,
    pid => 123,
  });
...
$test->for('example', 1, 'error_on_setid', sub {
  ...
  is $name, "on.setid";
  my $render = $result->render;
  is $render, "Can't start a new session: $!";
...
This package may raise an C<on.stderr> error, as an instance of
C<Venus::Cli::Error>, via the C<error_on_stderr> method.
...
=example-1 error_on_stderr
  ...
  my $error = $parent->error_on_stderr({
    error => $!,
    path => "/nowhere",
    pid => 123,
  });
...
$test->for('example', 1, 'error_on_stderr', sub {
  ...
  is $name, "on.stderr";
  my $render = $result->render;
  is $render, "Can't redirect STDERR to \"/nowhere\": $!";
...
This package may raise an C<on.stdin> error, as an instance of
C<Venus::Cli::Error>, via the C<error_on_stdin> method.
...
=example-1 error_on_stdin
  ...
  my $error = $parent->error_on_stdin({
    error => $!,
    path => "/nowhere",
    pid => 123,
  });
...
$test->for('example', 1, 'error_on_stdin', sub {
  ...
  is $name, "on.stdin";
  my $render = $result->render;
  is $render, "Can't redirect STDIN to \"/nowhere\": $!";
...
This package may raise an C<on.stdout> error, as an instance of
C<Venus::Cli::Error>, via the C<error_on_stdout> method.
...
=example-1 error_on_stdout
  ...
  my $error = $parent->error_on_stdout({
    error => $!,
    path => "/nowhere",
    pid => 123,
  });
...
$test->for('example', 1, 'error_on_stdout', sub {
  ...
  is $name, "on.stdout";
  my $render = $result->render;
  is $render, "Can't redirect STDOUT to \"/nowhere\": $!";
...
This package may raise an C<on.timeout.poll> error, as an instance of
C<Venus::Cli::Error>, via the C<error_on_timeout_poll> method.
...
=example-1 error_on_timeout_poll
  ...
  my $error = $parent->error_on_timeout_poll({
    code => sub{},
    timeout => 0,
  });
...
$test->for('example', 1, 'error_on_timeout_poll', sub {
  ...
  isa_ok $result, 'Venus::Error';
  my $name = $result->name;
  is $name, "on.timeout.poll";
  my $render = $result->render;
  is $render, "Timed out after 0 seconds in process 12345 while polling __ANON__";
...
This package may raise an C<on.timeout.pool> error, as an instance of
C<Venus::Cli::Error>, via the C<error_on_timeout_pool> method.
...
=example-1 error_on_timeout_pool
  ...
  my $error = $parent->error_on_timeout_pool({
    pool_size => 2,
    timeout => 0,
  });
...
$test->for('example', 1, 'error_on_timeout_pool', sub {
  ...
  isa_ok $result, 'Venus::Error';
  my $name = $result->name;
  is $name, "on.timeout.pool";
  my $render = $result->render;
  is $render, "Timed out after 0 seconds in process 12345 while pooling";
...
This package may raise an C<on.timeout.sync> error, as an instance of
C<Venus::Cli::Error>, via the C<error_on_timeout_sync> method.
...
=example-1 error_on_timeout_sync
  ...
  my $error = $parent->error_on_timeout_sync({
    pool_size => 2,
    timeout => 0,
  });
...
$test->for('example', 1, 'error_on_timeout_sync', sub {
  ...
  isa_ok $result, 'Venus::Error';
  my $name = $result->name;
  is $name, "on.timeout.sync";
  my $render = $result->render;
  is $render, "Timed out after 0 seconds in process 12345 while syncing";
